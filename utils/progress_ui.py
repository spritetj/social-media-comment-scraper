...
class ProgressTracker:
    ...
    def _build_html(self) -> str:
        ...
        return (
            ...
            ".prg-dot{width:8px;height:8px;border-radius:50%;background:#86868B;display:inline-block}"
            ".prg-dot-active{background:#0071E3;animation:prg-pulse 1.5s ease infinite}"
            ".prg-dot-done{background:#34C759}"
            ".prg-label{font-size:0.875rem;color:#1D1D1F;font-weight:400}"
            ".prg-counter{font-size:1.75rem;font-weight:700;color:#1D1D1F;"
            "font-family:'SF Pro Display','Helvetica Neue',sans-serif;letter-spacing:-0.02em;line-height:1}"
            ".prg-bar{height:3px;background:#D2D2D7;border-radius:2px;overflow:hidden}"
