...
class ProgressTracker:
    ...
    def _build_html(self) -> str:
        ...
        return (
            ...
            ".prg-label{font-size:0.875rem;color:#1D1D1F;font-weight:500}"
            ".prg-counter{font-size:1.75rem;font-weight:700;color:#1D1D1F;letter-spacing:-0.02em;line-height:1}"
            ".prg-bar{height:3px;background:#E8E6E1;border-radius:2px;overflow:hidden}"
            ".prg-bar-fill{height:100%;border-radius:2px;transition:width 0.6s cubic-bezier(0.4,0,0.2,1)}"
            ".prg-bar-active{background:linear-gradient(90deg,#1D1D1F,rgba(29,29,31,0.3));"
